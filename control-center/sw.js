const CACHE='trama-control-center-v3';
const SHELL=['./','./index.html','./manifest.webmanifest','./icons/icon-192.svg','./icons/icon-512.svg','./data/ecosystem-snapshot.json'];
...
self.addEventListener('fetch',event=>{
  ...
  if(u.pathname.endsWith('/data/ecosystem-snapshot.json')){
