...
| LAW-IT-AP-01 | LAW | D.M. 9 dicembre 2025, n. 221 — Regolamento recante Indicazioni nazionali per il curricolo della scuola dell'infanzia e del primo ciclo | Ministero dell'Istruzione e del Merito / Gazzetta Ufficiale | 2025; in vigore 2026 | scuola italiana 3–14 | binding regulation nel proprio ambito | quadro curricolare nazionale applicabile secondo decorrenza e grado | diretta come fonte normativa curricolare; binding operativo in TRAMA gestito da Arena | https://www.gazzettaufficiale.it/atto/serie_generale/caricaDettaglioAtto/originario?atto.codiceRedazionale=26G00021&atto.dataPubblicazioneGazzetta=2026-01-27&elenco30giorni=true | 2026-09-23 | independent normative-context review | VERIFIED | non sostituisce il binding curricolare Arena né autorizza Atlas a creare obiettivi |
...
## Riferimenti contestuali non claim-bearing

I riferimenti seguenti restano **bibliografia contestuale** e non sono usati, in questa versione, come Source ID per sostenere requisiti o claim verificati. Prima che uno di essi venga usato in una Traceability Matrix deve essere promosso nel registro con ID stabile, localizzatore verificabile, claim supportato, applicabilità e limiti.

- letteratura sulla **self-explanation** richiamata nel dossier;
- letteratura su **Productive Failure** / Manu Kapur;
- riferimenti **EEF Early Years** su talk, thinking e self-regulation;
- **DigComp 2.2** come contesto di competenza digitale;
- documentazione **MDN** su PWA, Service Worker, Web App Manifest e IndexedDB come riferimento tecnico implementativo.

Questa separazione evita di attribuire a tali riferimenti lo stesso stato delle fonti già tracciate in tabella.
