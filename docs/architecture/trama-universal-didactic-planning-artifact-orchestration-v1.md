...
## 16. Protected work and closed-pilot baseline
...
In particolare, eventuali modifiche future a:
...
devono preservare gli esiti validati di ECO-02/P1 e, quando incidono sul runtime o sui relativi invarianti, essere considerate ad alto rischio di collisione e richiedere un gate separato.
...
11. non riapre né altera il runtime e gli invarianti validati da ECO-02/P1;
...
- `STATUS.md` — ECO-02/P1 CLOSED / HUMAN PASS, R4-P1 PLANNED / NO_RUNTIME, R3-P4 NOT AUTHORIZED, DOS-A1 RUNTIME_DEFERRED;
